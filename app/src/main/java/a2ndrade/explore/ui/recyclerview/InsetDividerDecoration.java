package a2ndrade.explore.ui.recyclerview;
...
public class InsetDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    private final Set<Class> dividedClasses;
    private final Paint paint;
    private final int inset;
    private final int height;

    public InsetDividerDecoration(Set<Class> dividedViewHolderClass, int dividerHeight, int leftInset, @ColorInt int dividerColor) {
        dividedClasses = dividedViewHolderClass;
        inset = leftInset;
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (dividedClasses.contains(viewHolder.getClass())) {
